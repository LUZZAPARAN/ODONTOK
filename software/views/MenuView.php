                        ...
                        <nav class="mt-5">
                            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                                ...
                                <?php }
                                    ...
                                    <li class="nav-item">
                                        <a href="#" onclick="Menu.menu('helpOdontoController/helpOdontoMenu')" class="nav-link boton">
                                            <i class="fa-sharp fa-solid fa-circle-question fa-beat"></i>
                                ...
                                <?php } else { ?>
                                    ...
                                    <li class="nav-item">
                                        <a href="#" onclick="Menu.menu('helpController/helpMenu')" class="nav-link boton">
                                            <i class="fa-sharp fa-solid fa-circle-question fa-beat"></i>
                                            <p class="ml-2">Ayuda</p>
                                        </a>
                                    </li>
