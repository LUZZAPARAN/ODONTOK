                            ...
                            <tr>
                                ...
                                <?php if ($_SESSION['cod_role'] == 104) { ?>
                                    <td class="text-center">
                                        <i class="fa-sharp fa-solid fa-pen-to-square" onclick="Procedure.showProcedure('<?php echo $cod_procedure ?>');" style="color: #16a239;cursor:pointer;margin-right: 7px;"></i>
                                        <i class="fa-solid fa-trash" style="color: #d93b30;cursor:pointer;"onclick="Procedure.deleteProcedure('<?php echo $cod_procedure ?>');"> </i>
                                    </td>
