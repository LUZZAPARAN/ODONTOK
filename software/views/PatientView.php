        ...
        <div>
            <form id="insert_patient">
                ...
                <div class="form-group col">
                        <label for="name_patient">Por favor llene todos los datos marcados como obligatorios (*)</label>
                    </div>
                </div>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-center"><?php echo $blood_type ?></td>
                                    <td><?php echo $phone ?></td>  
                                            
                                    <td><?php echo $age ?></td>
                                    <?php if($_SESSION['cod_role'] == '104') { ?>
                                        <td class="text-center">
                                            <i class="fa-sharp fa-solid fa-pen-to-square" onclick="Patient.showPatient('<?php echo $cod_patient ?>');" style="color: #16a239;cursor:pointer;margin-right: 7px;"></i>
                                            <i class="fa-solid fa-trash" style="color: #d93b30;cursor:pointer;"onclick="Patient.deletePatient('<?php echo $cod_patient ?>');"> </i>
                                        </td>
                                    <?php } ?>
                                </tr>
                            <?php
