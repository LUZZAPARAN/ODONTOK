...
class PatientController
{
    ...
    function insertPatient(){
        ...
        if (
            ...
            $number_document == "" || $cod_blood_type == "Seleccione el grupo sanguineo" || $birth_date == "" || $phone == ""
        ) {
            ...
            $array_message = ['message' => 'Ya existe un paciente con ese documento'];
            exit(json_encode($array_message));
    ...
    function deletePatient(){
        ...
        $PatientModel->deletePatient($cod_patient);
